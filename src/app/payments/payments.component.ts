...
pre=new Prepaid();
  ...
  phoneNo = localStorage["mobileNumberUser"];
  cost =localStorage["newPrice"];
  validity =localStorage["newValidity"];
  benefits=localStorage["newPlan"];
...
getUser(){
  ...
  onPay(m: string) {
    this.payment.emailId = localStorage["emailUser"];
    this.payment.name = localStorage["firstNameUser"];
    this.payment.phone = localStorage["mobileNumberUser"];
    this.payment.service = localStorage["typeUser"];
    this.payment.cost = localStorage["newPrice"];
    this.payment.validity = localStorage["newValidity"];
    this.payment.benifits = localStorage["newPlan"];
